...
<html lang="pt-br" dir="ltr">
  <head>
    ...
    <meta name="title" content="<?php echo $tituloPoliticas ?>">
    ...
    <title><?php echo $tituloPoliticas ?></title>
  </head>
<body>
<!-- HEADER -->
<?php
  ...
  <main class="container-fluid">
    ...
    <section class="top row">
      <article class="top-title col-12">
        <h1><?php echo $tituloPoliticas ?></h1>
        <h4><?php echo $subtituloPoliticas ?></h4>
      </article>
      <p>
