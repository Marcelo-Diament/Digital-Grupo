...
<html lang="pt-br" dir="ltr">
  <head>
    ...
    <title><?php echo $categorias['Óculos de Sol']['titulo'] ?></title>
    <!-- ESTILOS, FONTES... -->
    ...
    <!-- META DATA (SEO) / OG -->
    <meta name="title" content="<?php echo $categorias['Óculos de Sol']['metaTitle'] ?>">
    <meta name="author" content="<?php echo $autores ?>">
    <meta name="description" content="<?php echo $categorias['Óculos de Sol']['metaDesc'] ?>">
    <meta name="keywords" content="<?php echo $categorias['Óculos de Sol']['metaKeyWords'] ?>">
    <meta name="robots" content="index,follow">
    <meta property="og:site_name" content="<?php echo $metaOgSiteName ?>" />
    <meta property="og:title" content="<?php echo $categorias['Óculos de Sol']['metaOgTitle'] ?>" />
    <meta property="og:description" content="<?php echo $categorias['Óculos de Sol']['metaOgDesc'] ?>" />
    <meta property="og:url" content="<?php echo $categorias['Óculos de Sol']['metaOgUrl'] ?>" />
    <meta property="og:locale" content="<?php echo $categorias['Óculos de Sol']['metaOgLocal'] ?>" />
    <meta property="og:type" content="<?php echo $categorias['Óculos de Sol']['metaOgType'] ?>" />
    <meta property="og:image" content="<?php echo $categorias['Óculos de Sol']['metaOgImage'] ?>" />
    <meta property="og:image:alt" content="<?php echo $categorias['Óculos de Sol']['metaOgImageAlt'] ?>" />
    <meta property="og:image:url" content="<?php echo $categorias['Óculos de Sol']['metaOgImageUrl'] ?>" />
    <meta property="og:image:type" content="<?php echo $categorias['Óculos de Sol']['metaOgImageType'] ?>" />
  </head>
<body>
<!-- HEADER -->
<?php
  ...
  <main class="container-fluid">
    ...
    <section class="top row">
      <article class="top-title col-12">
        <h1><?php echo $categorias['Óculos de Sol']['titulo'] ?></h1>
        <h4><?php echo $categorias['Óculos de Sol']['subtitulo'] ?></h4>
      </article>
      <p>
        ...
        <?php echo $categorias['Óculos de Sol']['titulo'] ?>
      </p>
    </section>
