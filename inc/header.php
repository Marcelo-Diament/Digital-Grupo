  <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-white fixed-top">
    <a title="Clique para acessar a página inicial" alt="Clique para a acessar a página inicial" class="navbar-brand" href="http://digitalgrupo.provisorio.ws/index.php"><img src="http://digitalgrupo.provisorio.ws/assets/images/logo.png" alt="Logo do Digital Grupo" title="Clique para acessar a página inicial" height="50px" width="50px"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto text-white d-flex justify-content-around">
        <li class="nav-item active">
          <a title="Acessar página inicial" alt="Acessar página inicial" class="nav-link" href="http://digitalgrupo.provisorio.ws/index.php">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
          <a title="Conheça melhor o Digital Grupo" alt="Conheça melhor o Digital Grupo" class="nav-link" href="http://digitalgrupo.provisorio.ws/sobre.php">Sobre</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a title="Clique para ver todos os produtos" alt="Clique para ver todos os produtos" class="dropdown-item" href="http://digitalgrupo.provisorio.ws/produtos.php">Todos os produtos</a>
            <a title="Clique para solicitar seu produto sob encomenda" alt="Clique para solicitar seu produto sob encomenda" class="dropdown-item" href="http://digitalgrupo.provisorio.ws/contato.php">Produtos customizados</a>
          </div>
        </li>

        <li class="nav-item">
          <a title="Clique para ver as perguntas feitas com maior frequência" alt="Clique para ver as perguntas feitas com maior frequência" class="nav-link" href="http://digitalgrupo.provisorio.ws/faq-duvidas.php">FAQ</a>
        </li>
        <li class="nav-item">
