      ...
      <article class="row">
        <div class="col-12 col-md-5">
          <div class="w3-content">
            ...
            <img itemprop="image" id="pdt-det-img1" src="<?php echo $produtos[$idProduto]['imagens']['Roda 01']; ?>" alt="Cor 01" title="Cor 01" class="pdt-det-img" style="width:100%;max-width:500px;">
            <img itemprop="image" id="pdt-det-img2" src="<?php echo $produtos[$idProduto]['imagens']['Roda 02']; ?>" alt="Cor 02" title="Cor 02" class="pdt-det-img" style="width:100%;max-width:500px;">
            <img itemprop="image" id="pdt-det-img" src="<?php echo $produtos[$idProduto]['imagens']['Roda 03']; ?>" alt="Cor 03" title="Cor 03" class="pdt-det-img" style="width:100%;max-width:500px;">

            <div class="w3-row-padding w3-section">
              <div class="w3-col s4">
                <img itemprop="image" alt="Cor 01" title="Cor 01" class="pdt-det-img-zoom w3-opacity w3-hover-opacity-off" src="<?php echo $produtos[$idProduto]['imagens']['Roda 01']; ?>" style="width:100%" onclick="currentDiv(1)">
              </div>
              <div class="w3-col s4">
                <img itemprop="image" alt="Cor 02" title="Cor 02" class="pdt-det-img-zoom w3-opacity w3-hover-opacity-off" src="<?php echo $produtos[$idProduto]['imagens']['Roda 02']; ?>" style="width:100%" onclick="currentDiv(2)">
              </div>
              <div class="w3-col s4">
                <img itemprop="image" alt="Cor 03" title="Cor 03" class="pdt-det-img-zoom w3-opacity w3-hover-opacity-off" src="<?php echo $produtos[$idProduto]['imagens']['Roda 03']; ?>" style="width:100%" onclick="currentDiv(3)">
              </div>
            </div>
          ...
          <div class="row">
            <div class="comprar col-12 col-sm-6" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
              ...
              <form action="" method="post">
                ...
                <label for="tamanhos">Rolamento</label>
                <select name="tamanhos">
                  <option name='tamanho' value='' disabled>Selecione seu rolamento</option>
                  <!--<option value=""></option>-->
                  <?php 
                    ...
                    foreach ($produtos[$idProduto]['estoque']['rolamentos'] as $key => $value) {
                ...
                if (isset($_POST['submit'])) {
                  ...
                  if ($_POST['submit'] === 'Favoritar'){
                      ...
                      // OU, SE SÓ TIVER TAMANHO SELECIONADO
                        ...
                        //$corEscolhida = "";
                        echo "<p class='faltaInfo alertando'>Adicionamos o item ".$nomeProduto." (rolamento ".$tamanhoEscolhido.") na sua lista de favoritos! =)</p>";

                      // OU, SE TIVER COR E TAMANHO SELECIONADOS:
                      }else /*if (isset($_POST['cores']) && isset($_POST['tamanhos']))*/{
                        $corEscolhida = $_POST['cores'];
                        $tamanhoEscolhido = $_POST['tamanhos'];
                        echo "<p class='adicionado alertando'>Adicionamos o item ".$nomeProduto." (rolamento ".$tamanhoEscolhido." e cor ".$corEscolhida.") na sua lista de favoritos! =)</p>";}
                  ...
                  if ($_POST['submit'] === 'Adicionar'){
                    ...
                    if (empty($_POST['cores']) && empty($_POST['tamanhos'])){
                      echo "<p class='faltaInfo alertando'>Selecione uma cor e um rolamento para o seu ".$nomeProduto.", por favor  :P</p>";

                    // OU, SE SÓ TIVER COR SELECIONADA
                    } elseif (isset($_POST['cores']) && empty($_POST['tamanhos'])){
                      $corEscolhida = $_POST['cores'];
                      echo "<p class='faltaInfo alertando'>Qual rolamento do seu ".$nomeProduto." (cor ".$corEscolhida.") você deseja?</p>";
                      return $corEscolhida;
                    ...
                    // SÓ TIVER TAMANHO SELECIONADO
                      ...
                      $tamanhoEscolhido = $_POST['tamanhos'];
                      $corEscolhida = "";
                      echo "<p class='faltaInfo alertando'>De que cor você quer o seu ".$nomeProduto." (rolamento:".$tamanhoEscolhido.")?</p>";
                    ...
                    // OU, SE TIVER COR E TAMANHO SELECIONADOS:
                      ...
                      // JÁ, SE HOUVER QUANTIDADE DEFINIDA (PADRÃO É 1)
                        ...
                        echo "<p class='adicionado alertando'>Adicionamos ".$qntEscolhida." item(ns) ".$nomeProduto." (rolamento ".$tamanhoEscolhido." e cor ".$corEscolhida.") ao carrinho!</p>";
                      }
                    }
                  }
                }
