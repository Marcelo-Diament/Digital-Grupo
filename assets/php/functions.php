	...
	// # VARIÁVEIS (ENQUANTO NÃO INTEGRAMOS AO BANCO DE DADOS)
		...
		$metaOgSiteName = $nomeNegocio;
		    ...
		    // ### PRODUTO (DETALHES)
			    ...
			    $nomeProduto = "Roda de Skate A";
			    $descricaoProduto = "O produto é excelente, confira a seguir todos os detalhes!";
			    $metaTitleProduto = $nomeProduto;
		    	$metaDescProduto = "Roda de Skate A | Ótima rodinha de skate para andar de skate na rua e em pistas";
		    	$metaKeyWordsProduto ="roda de skate, rodinha de skate, skate, acessórios de skate";
			    ...
			    $metaOgImageAltProduto = "Rodinha de Skate";
			    $metaOgImageUrlProduto = $metaOgImageProduto;
			    $metaOgImageTypeProduto = "image/gif";

			    // #### DESCRIÇÃO (DETALHES, ESPECIFICAÇÕES DO PRODUTO)
			    $pdtMateriais = "Plástico, metal e borracha";
			    $tamanhos = ['XS - Extrapequeno' => 'XS - Extrapequeno', 'SM - Pequeno'=>'SM - Pequeno','M - Médio'=>'M - Médio','LG - Grande'=>'LG - Grande', 'XL - Extragrande' =>'XL - Extragrande'];
			    $tamanho = 'A grade de tamanhos de nossos produtos segue as normativas da ABNT e incluem os tamanhos XS, SM, M, LG e XL. Para confecção dos produtos sobmedida, entre em contato conosco.';
			    ...
			    $produtos = array(
					...
					array(
			    		'idProduto' => '5',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-e.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate E',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate E',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate E',
					    'metaOgDesc' => 'Roda de Skate E de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-e.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate E',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '6',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-f.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => false,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate F',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate F',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate F',
					    'metaOgDesc' => 'Roda de Skate F de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-f.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate F',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '7',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-g.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate G',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate G',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate G',
					    'metaOgDesc' => 'Roda de Skate G de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-g.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate G',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '8',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-h.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate H',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate H',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate H',
					    'metaOgDesc' => 'Roda de Skate H de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-h.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate H',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '9',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-i.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate I',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate I',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate I',
					    'metaOgDesc' => 'Roda de Skate I de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-i.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate I',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '10',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-j.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => false,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate J',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate J',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate J',
					    'metaOgDesc' => 'Roda de Skate J de diferentes durezas e para diversos estilos - street skating, skate Jowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-j.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate J',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '11',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-k.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate K',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate K',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate K',
					    'metaOgDesc' => 'Roda de Skate K de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-k.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate K',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '12',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-l.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate L',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate L',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate L',
					    'metaOgDesc' => 'Roda de Skate L de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-l.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate L',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '13',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-m.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate M',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate M',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate M',
					    'metaOgDesc' => 'Roda de Skate M de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-m.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate M',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '14',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-n.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => false,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate N',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate N',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate N',
					    'metaOgDesc' => 'Roda de Skate N de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-n.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate N',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '15',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-o.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate O',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate O',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate O',
					    'metaOgDesc' => 'Roda de Skate O de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-o.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate O',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '16',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-p.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate P',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate P',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate P',
					    'metaOgDesc' => 'Roda de Skate P de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-p.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate P',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '17',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-q.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate Q',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate Q',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate Q',
					    'metaOgDesc' => 'Roda de Skate Q de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-q.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate Q',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '18',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-r.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => false,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate R',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate R',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate R',
					    'metaOgDesc' => 'Roda de Skate R de diferentes durezas e para diversos estilos - street skating, skate Rowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-r.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate R',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '19',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-s.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate S',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate S',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate S',
					    'metaOgDesc' => 'Roda de Skate S de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-s.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate S',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '20',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-t.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate T',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate T',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate T',
					    'metaOgDesc' => 'Roda de Skate T de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-t.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate T',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '21',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-u.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate U',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate U',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate U',
					    'metaOgDesc' => 'Roda de Skate U de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-u.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate U',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-amarela-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '22',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-v.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => false,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate V',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate V',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate V',
					    'metaOgDesc' => 'Roda de Skate V de diferentes durezas e para diversos estilos - street skating, skate Vowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-v.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate V',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '23',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-w.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate W',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate W',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate W',
					    'metaOgDesc' => 'Roda de Skate W de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-w.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate W',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '24',
			    		'url' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-x.php',
			    		'idCategoria' => '1',
			    		'categoria' => 'Rodas de Skate',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Roda de Skate X',
			    		'descricao' => 'Roda indicada tanto para skatistas que descem ladeiras fazendo slides mais bruscos quanto para skatistas que andam em half, mini ramp e bowl. As rodas são macias e espessas, possibilitando uma vida útil mais longa para as rodas do seu skatinho ou long',
			    		'metaTitle' => 'Roda de Skate X',
			    		'metaDesc' => 'Roda de Skate especial para slides. Serve tanto para street quanto para pistas inddor e outdoor',
			    		'metaKeyWords' => 'skate, skt, sk8, roda de skt, roda de skate, roda de sk8, rodinha de skate, rodinha de skt, rodinha de sk8, rodinha skate, rodinha skt, rodinha sk8, roda para bowl, rodinha para bowl, roda para street, rodinha para street, roda para mini ramp, rodinha para mini ramp, roda para half, rodinha para half, roda para slide, rodinha para slide',
					    'metaOgTitle' => 'Roda de Skate X',
					    'metaOgDesc' => 'Roda de Skate X de diferentes durezas e para diversos estilos - street skating, skate bowl, skate em half e mini ramp',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/rodas-de-skate/roda-de-skate-x.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageAlt' => 'Rodas de Skate X',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/roda-de-skate-verde-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '29',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-e.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol E',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol E',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol E',
					    'metaOgDesc' => 'Óculos de Sol E - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-e.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol E',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '30',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-f.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol F',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol F',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol F',
					    'metaOgDesc' => 'Óculos de Sol F - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-f.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol F',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '31',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-g.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol G',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol G',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol G',
					    'metaOgDesc' => 'Óculos de Sol G - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-g.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol G',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '32',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-h.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol H',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol H',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol H',
					    'metaOgDesc' => 'Óculos de Sol H - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-h.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol H',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '33',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-i.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol I',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol A',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol I',
					    'metaOgDesc' => 'Óculos de Sol I - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-i.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol I',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '34',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-j.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol J',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol B',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol J',
					    'metaOgDesc' => 'Óculos de Sol J - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-j.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol J',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '35',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-k.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol K',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol K',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol K',
					    'metaOgDesc' => 'Óculos de Sol K - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-k.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol K',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '36',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-l.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol L',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol L',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol L',
					    'metaOgDesc' => 'Óculos de Sol L - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-l.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol L',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '37',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-m.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol M',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol M',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol M',
					    'metaOgDesc' => 'Óculos de Sol M - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-m.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol M',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '38',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-n.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol N',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol N',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol N',
					    'metaOgDesc' => 'Óculos de Sol N - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-n.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol N',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '39',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-o.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol O',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol O',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol O',
					    'metaOgDesc' => 'Óculos de Sol O - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-o.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol O',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '40',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-p.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol P',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol P',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol P',
					    'metaOgDesc' => 'Óculos de Sol P - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-p.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol P',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '41',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-q.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol Q',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol Q',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol Q',
					    'metaOgDesc' => 'Óculos de Sol Q - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-q.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol Q',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '42',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-r.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol R',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol R',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol R',
					    'metaOgDesc' => 'Óculos de Sol R - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-r.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol R',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '43',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-s.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol S',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol S',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol S',
					    'metaOgDesc' => 'Óculos de Sol S - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-s.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol S',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '44',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-t.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol T',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol T',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol T',
					    'metaOgDesc' => 'Óculos de Sol T - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-t.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol T',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '45',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-u.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol U',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol A',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol U',
					    'metaOgDesc' => 'Óculos de Sol U - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-u.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol U',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-amarelo-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '46',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-v.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol V',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol V',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol V',
					    'metaOgDesc' => 'Óculos de Sol V - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-v.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol V',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-azul-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '47',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-w.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol W',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol W',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol W',
					    'metaOgDesc' => 'Óculos de Sol W - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-w.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol W',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-laranja-01.jpg',
					    'imagens' => array(
					...
					array(
			    		'idProduto' => '48',
			    		'url' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-x.php',
			    		'idCategoria' => '2',
			    		'categoria' => 'Óculos de Sol',
			    		'promocao' => true,
			    		'dataLancamento' => '2018/07/02',
			    		'nome' => 'Óculos de Sol X',
			    		'descricao' => 'Óculos escuro estiloso, feito para quem gosta de fazer bonito. Sua lente polarizada permite ao dono desse objeto de desejo que fique em ambientes altamente iluminados sem o risco de prejudicar seus olhos nem sua visão. Altamente recomendado para quem joga xadrez, poker ou dominó',
			    		'metaTitle' => 'Óculos de Sol X',
			    		'metaDesc' => 'Óculos de Sol especial para cegos',
			    		'metaKeyWords' => 'óculos, óculos de sol, óculos escuros, óculos de sol, lupa, óculos solar, óculos escuro de grau, óculos solar de grau, óculos de sol de grau',
					    'metaOgTitle' => 'Óculos de Sol X',
					    'metaOgDesc' => 'Óculos de Sol X - feito para cegos que não precisam ver pra crer',
					    'metaOgUrl' => 'http://digitalgrupo.provisorio.ws/oculos-de-sol/oculos-de-sol-x.php',
					    'metaOgLocal' => 'pt-BR',
					    'metaOgType' => 'website',
					    'metaOgImage' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageAlt' => 'Óculos de Sol X',
					    'metaOgImageUrl' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'metaOgImageType' => 'image/jpg',
					    'imagemDestaque' => 'http://digitalgrupo.provisorio.ws/assets/images/oculos-escuros-roxo-01.jpg',
					    'imagens' => array(
		...
		// ## ADITIVOS (BANNERS, POP UPS, ALERTAS, MODAIS...)
		    ...
		    // ### BANNERS
			$bannerHorizontal = "Confira nossa promoção imperdível! Acesse já!";
